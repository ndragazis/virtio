...
Device MUST report the number of vectors supported in \field{Table Size}
in the MSI-X Capability as specified in \hyperref[intro:PCI]{[PCI]}.

Device MUST support mapping any master queue event to any valid vector 0
to MSI-X \field{Table Size}. Device MUST support unmapping any master
queue event.
